      ...
      ">
        ...
        ">
          <div className="mx-auto max-w-2xl sm:text-center">
              ...
              text-indigo-600
              ">
                Your Interactive Documnet Companion
              </h2>
        ...
        px-6 sm:mt-20 md:mt-24 lg:px-8">
          <dl
          className="
          mx-auto grid max-w-2xl grid-cols-1 gap-x-6
          gap-y-10 text-base leading-7 text-gray-600 sm:grid-cols-2
          lg:mx-0 lg:max-w-none lg:grid-cols-3 lg:gap-x-8
          lg:gap-y-16
          "
          >
